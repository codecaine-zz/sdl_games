...
fn (app &App) render() {
	...
	draw_smiley_face(r, app.face_rect.x + 20, app.face_rect.y + 20, 14, face_state, face_pressed)
	...
	for row in 0 .. app.game.rows {
		for col in 0 .. app.game.cols {
			...
			if cell.state == .revealed {
				...
				if cell.is_mine {
					draw_mine_icon(r, cx + app.cell_size / 2, cy + app.cell_size / 2, app.cell_size - 4, cell.exploded)
				...
				if cell.state == .flagged {
					if cell.wrong_flag {
						draw_wrong_flag_icon(r, cx + app.cell_size / 2, cy + app.cell_size / 2, app.cell_size - 6)
					} else {
						draw_flag_icon(r, cx + app.cell_size / 2, cy + app.cell_size / 2, app.cell_size - 6)
					}
