...
pub fn draw_mine_icon(renderer &sdl.Renderer, cx int, cy int, size int, exploded bool) {
	r := size / 3
...
pub fn draw_flag_icon(renderer &sdl.Renderer, cx int, cy int, size int) {
	// Base
...
pub fn draw_wrong_flag_icon(renderer &sdl.Renderer, cx int, cy int, size int) {
	draw_flag_icon(renderer, cx, cy, size)
...
pub fn draw_smiley_face(renderer &sdl.Renderer, cx int, cy int, r int, face FaceState, is_pressed bool) {
	// Yellow Face Circle
