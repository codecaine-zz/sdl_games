...
pub fn render_game(renderer &sdl.Renderer, game &WorldRunnerGame, win_w int, win_h int) {
	...
	render_3d_volumetric_obstacles(renderer, game, win_w, win_h)

	// 4. Render Segmented Serpent Dragon Boss
	if game.has_boss && game.boss.active {
		render_dragon_boss_hd(renderer, game, win_w, win_h)
	}
	...
	render_player_commando_hd(renderer, game, win_w, win_h)
...
fn render_3d_volumetric_obstacles(renderer &sdl.Renderer, game &WorldRunnerGame, win_w int, win_h int) {
...
fn render_dragon_boss_hd(renderer &sdl.Renderer, game &WorldRunnerGame, win_w int, win_h int) {
	boss := &game.boss
...
fn render_player_commando_hd(renderer &sdl.Renderer, game &WorldRunnerGame, win_w int, win_h int) {
	p := &game.player
