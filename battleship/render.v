...
pub fn render_battleship_game(renderer &sdl.Renderer, mut g BattleshipGame, w int, h int, mx int, my int) {
	...
	draw_text(renderer, w - 240, 48, 'SHOTS: ${g.shots_fired_p1} | ACCURACY: ${acc}%', 1, Color{r:255,g:220,b:100})
	...
	// Render Right Grid (Targeting Radar)
	for gy in 0 .. grid_size {
		for gx in 0 .. grid_size {
	...
	// Bottom Command Interface & Fleet Status Panel
	panel_y := h - 170
