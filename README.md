...
- **Objective**: Rally the bouncing square ball across the digital screen with your paddle. Angle your returns to slip the ball past your opponent's paddle and score 11 points to win!
- **Controls**:
  - `W` / `S`: Player 1 (Left Paddle) vertical movement.
  - `Up` / `Down`: Player 2 (Right Paddle) vertical movement.
  - `Tab`: Toggle AI opponent on/off.
  - `1`: Classic Retro 1972 Black & White mode.
  - `2`: Cyberpunk Neon Glow mode with particle trails.
  - `R`: Reset match.
- **Rules & Mechanics**:
  - Paddle Angle Physics: Striking the ball near the paddle edge imparts sharp return angles.
  - Ball speed increases with each consecutive rally volley.
  - First player to score 11 points wins the match.
- **Pro Tip**: Slice your paddle across the ball during contact to impart maximum deflection angle and catch the opponent out of position!
...
- **Controls**:
  ...
  - `Hold Left Click` + `Drag Back`: Draw cue stick back to set shot power.
