...
fn main() {
	...
	if os.args.contains('--snap') {
		...
		render_yahtzee_game(renderer, mut snap_game, win_w, win_h, 0, 0, true)
	...
	window := sdl.create_window(
		'Yahtzee Deluxe - Classic 5-Dice Strategy & Scorecard'.str,
	...
	for running {
		...
		render_yahtzee_game(renderer, mut app.game, win_w, win_h, app.mouse_x, app.mouse_y, app.sound_mgr.enabled)
