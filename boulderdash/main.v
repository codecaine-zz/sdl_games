...
fn draw_tile(renderer &sdl.Renderer, x int, y int, tile int, anim_tick f64) {
...
fn (mut app App) render() {
	...
	for r in 0 .. cave.height {
		for c in 0 .. cave.width {
			draw_tile(renderer, board_x + c * cell_size, board_y + r * cell_size, cave.grid[r][c], app.anim_tick)
		}
	}
	...
	if cave.level_completed {
		...
		sdl.render_fill_rect(renderer, &banner)
		draw_text_centered(renderer, win_width / 2, 708, 'GAME OVER - OUT OF LIVES! PRESS [R] TO RESTART', 2, Color{r: 255, g: 100, b: 100})
