...
pub fn draw_jelly_puyo(renderer &sdl.Renderer, cx f64, cy f64, rad f64, color_id int, eye_dx f64, eye_dy f64) {
	if color_id == 0 {
		return
	}
...
pub fn render_puyo_game(renderer &sdl.Renderer, game &PuyoGame, win_w int, win_h int, particles []PuyoParticle) {
	...
	for r in 0 .. puyo_rows {
		for c in 0 .. puyo_cols {
			...
			if col > 0 {
				...
				draw_jelly_puyo(renderer, px, py, cell_sz * 0.44, col, 0.0, 0.0)
			}
		}
	}
	...
	if game.state == .falling {
		...
		draw_jelly_puyo(renderer, p1_x, p1_y, cell_sz * 0.44, game.pair.col1, dir_x, dir_y)
		draw_jelly_puyo(renderer, p2_x, p2_y, cell_sz * 0.44, game.pair.col2, -dir_x, -dir_y)
	}
	...
	draw_jelly_puyo(renderer, 85, 130, cell_sz * 0.4, game.next_pair.col2, 0.0, 1.0)
	draw_jelly_puyo(renderer, 85, 175, cell_sz * 0.4, game.next_pair.col1, 0.0, -1.0)
	...
	draw_text(renderer, board_x + board_w + 40, 60, 'PUYO PUYO', 3, Color{r: 255, g: 80, b: 120})
	draw_text(renderer, board_x + board_w + 40, 90, 'CASCADE', 3, Color{r: 60, g: 220, b: 255})

	draw_text(renderer, board_x + board_w + 40, 150, 'SCORE', 2, Color{r: 180, g: 190, b: 220})
	draw_text(renderer, board_x + board_w + 40, 175, '${game.score}', 3, Color{r: 255, g: 255, b: 255})

	draw_text(renderer, board_x + board_w + 40, 230, 'HIGH SCORE', 2, Color{r: 180, g: 190, b: 220})
	draw_text(renderer, board_x + board_w + 40, 255, '${game.high_score}', 3, Color{r: 255, g: 215, b: 0})

	draw_text(renderer, board_x + board_w + 40, 330, 'CONTROLS:', 1, Color{r: 255, g: 255, b: 255})
	draw_text(renderer, board_x + board_w + 40, 350, '[A / D / ARROWS] MOVE', 1, Color{r: 160, g: 180, b: 220})
	draw_text(renderer, board_x + board_w + 40, 370, '[W / UP / Z] ROTATE CW', 1, Color{r: 160, g: 180, b: 220})
