...
fn main() {
	...
	sdl.render_set_logical_size(renderer, win_w, win_h)
		...
		render_puyo_game(renderer, &snap_game, win_w, win_h, []PuyoParticle{})
	...
	for running {
			...
			match event.@type {
				...
				.keydown {
					...
					if sym == int(sdl.KeyCode.f11) {
						...
						if app.game.move_horiz(-1) { app.sound_mgr.play_rotate_sound() }
		...
		render_puyo_game(app.renderer, &app.game, win_w, win_h, app.particles)
		sdl.delay(16)
	}
}
