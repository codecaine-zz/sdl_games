...
pub fn render_game(renderer &sdl.Renderer, game &ContraGame, win_w int, win_h int) {
	...
	render_capsules_and_powerups(renderer, game, cx, cy)
	...
	render_players(renderer, game, cx, cy)
...
fn render_capsules_and_powerups(renderer &sdl.Renderer, game &ContraGame, cx f32, cy f32) {
...
fn render_players(renderer &sdl.Renderer, game &ContraGame, cx f32, cy f32) {
...
fn render_hud(renderer &sdl.Renderer, game &ContraGame, win_w int) {
	...
	if game.players.len > 0 {
		p1 := game.players[0]
		draw_text_shadow(renderer, '1P', 30, 8, 2, Color{r: 80, g: 180, b: 255}, Color{r: 0, g: 0, b: 0})
		draw_text_shadow(renderer, '${p1.score:06d}', 70, 8, 2, Color{r: 255, g: 255, b: 255}, Color{r: 0, g: 0, b: 0})
		...
		draw_text_shadow(renderer, 'LIVES: ${p1.lives:02d} [${w_letter}]', 190, 8, 2, Color{r: 255, g: 220, b: 0}, Color{r: 0, g: 0, b: 0})
	}

	// HIGH SCORE
	draw_text_shadow(renderer, 'HIGH', 400, 8, 2, Color{r: 255, g: 150, b: 50}, Color{r: 0, g: 0, b: 0})
	draw_text_shadow(renderer, '${game.high_score:06d}', 470, 8, 2, Color{r: 255, g: 255, b: 255}, Color{r: 0, g: 0, b: 0})

	// STAGE TITLE
	draw_text_shadow(renderer, game.stage_data.def.name, 620, 8, 2, Color{r: 200, g: 240, b: 255}, Color{r: 0, g: 0, b: 0})
}
