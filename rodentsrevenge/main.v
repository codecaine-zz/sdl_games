...
fn main() {
	...
	if os.args.contains('--snap') {
		...
		render_rodent_game(renderer, mut snap_game, win_w, win_h, true)
	...
	window := sdl.create_window(
		"Rodent's Revenge - 1991 Microsoft Windows Classic".str,
	...
	for running {
		...
		render_rodent_game(renderer, mut app.game, win_w, win_h, app.sound_mgr.enabled)
